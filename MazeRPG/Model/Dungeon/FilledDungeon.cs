...
internal class FilledDungeon : DungeonBase
{
    ...
    private void RemoveWalls(Tile tile1, Tile tile2)
    {
        tile1.IsWall = false;
        tile2.IsWall = false;

        _tiles[(tile1.X + tile2.X) / 2, (tile1.Y + tile2.Y) / 2].IsWall = false;
    }
}
